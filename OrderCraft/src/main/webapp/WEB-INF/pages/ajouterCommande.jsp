    ...
    <form action="${pageContext.request.contextPath}/AddCommande" method="post">
      ...
      <div class="form-group">
            ...
            <select class="form-control" id="client" name="client">
              ...
              <option value="-1">choisis  un client</option>
        ...
        <div class="form-group">
           ...
           <div class="form-group ">
                    ...
                    <input type="text" class="form-control" name="commande_description" required>
                    
                </div>
                				        
           <div class="form-group ">
                    <label for="dateDeCommande">Ajouter une date De Commande :</label>
                    <input class="form-control" type="date" name="dateDeCommande">
